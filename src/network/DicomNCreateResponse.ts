...
export class DicomNCreateResponse extends DicomResponse {
  constructor(command: DicomDataset);
  constructor(request: DicomNCreateRequest, status: number);
  constructor(commandOrRequest: DicomDataset | DicomNCreateRequest, status = 0x0000) {

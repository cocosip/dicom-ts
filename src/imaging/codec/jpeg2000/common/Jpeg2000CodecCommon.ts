...
function classifyJpeg2000Failure(error: unknown): Jpeg2000FailureClass {
  ...
  if (
    ...
    || message.includes("duplicate coc for component")
    || message.includes("duplicate qcc for component")
    || message.includes("duplicate tile coc for component")
    || message.includes("duplicate tile qcc for component")
    ...
    || message.includes("cod encountered before siz")
    || message.includes("qcd encountered before siz")
    || message.includes("coc encountered before siz")
    || message.includes("coc encountered before cod")
    || message.includes("qcc encountered before siz")
    || message.includes("qcc encountered before qcd")
    || message.includes("poc encountered before siz")
    || message.includes("poc encountered before cod")
    || message.includes("rgn encountered before siz")
    || message.includes("com encountered before siz")
    || message.includes("mct encountered before siz")
    || message.includes("mcc encountered before siz")
    || message.includes("mco encountered before siz")
